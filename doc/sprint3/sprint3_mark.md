...
## Planning Meetings (SR(N-1).md, sprintN.md) (max 2 marks)
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    Your Mark: 1   
    Feedback: Spikes are pretty vague and some of the points mentioned are not really spikes for a sprint (ie. Time management, coordinating meetings etc.). Team capacity needs to be more clear about each member's team capacity.

  Planning Meetings Total Mark: 1 / 4
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Is the pull request done by the person to whom the task has been assigned to?  (max 2 marks)
    ...
    Your Mark: 1   
    Feedback: DREAM-16, DREAM-74; Make sure the pull request is done by the person who is assigned to that ticket
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: 1   
    Feedback: Some user stories are missing the ticket number or the short description of the task
...
## Documentation (max 1 mark)
  ...
  Your Mark: 0 / 1  
  Feedback: Minor links updates made but we expect more documentation in particular to installation (ie. installing your softwares, versions, how to actually set up your project etc.)
