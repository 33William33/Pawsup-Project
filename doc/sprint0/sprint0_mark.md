...
## Documentation: README.md (max 3 marks)
  ...
  - Installation for your Software/System
    ...
    Your mark: _0.5 no commands were provided,
...
## Definition of done: done.md (max 2 marks)
  ...
  keep that in mind, "App and design is compatible with different mobile devices and formats. (i.e: Android, tablet, etc.)"
  it's tickky for the app (using xml layout) UI to look the same on phone and tablet.
...
## Process: process.md (max 10 marks)
  ...
  - Decision making (max 2 marks)
    ...
    Your mark: _  1 I'm a bit confused about your decision making.
  ...
  - Next phase (max 2 marks)
    ...
    Your mark: 0 I didn't see any plan for next phase
   
  process.md Total Mark: _7 / 10
