...
## Daily Stand-ups (max 10 marks)
  ...
  Some standup messages could use more detail/quality. Something like "connecting code to mongodb" or "implementing code" is not specific enough.
...
## User Stories (Tracked in Jira) (max 10 marks) 
  - Correctly formulated user stories (max 2 marks)
    ...
    Your Mark: 1 (for programmer and Fiona stories, missing the "so that i can...")
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 1 (DREAM-15 missing subtasks)
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 1 DREAM-46 missing Criteria of Satisfaction
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Do the pull request on GitHub match the tasks listed on Jira Active Sprint Board? (max 2 marks)
    ...
    Your Mark: 0 (missing DREAM56, 57, 59)
...
## Sprint Demo (Max 14 marks) 
  ...
  - Working software (max 2 marks)
    ...
    7/8
    Incomplete feature: set/edit price
...
- Birthday -> Birthdate + field would be better as a calendar picker
- Fields should show up as red when errors occur
- Delete icon should be a garbage icon
